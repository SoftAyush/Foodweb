                ...
                <div class="page-title-wrapper text-center">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="page-title-inner">
                            <h1 itemprop="headline">Italian Foods</h1>
                                <span>Our best Italian foods</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            <div class="sec-box">
                                <div class="remove-ext">
                                    <div class="row">
                                    <?php  
                                         $sql =" SELECT category.name, foods.foodname,foods.foodimage,foods.foodprice,foods.resid FROM category CROSS JOIN foods WHERE category.id = foods.category AND category.name='italian'";
